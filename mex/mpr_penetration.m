% MPR_PENETRATION Compute penetration depth, separation direction, and
% contact position between two intersecting convex hulls using the
% Minkowski Portal Refinement (MPR) algorithm.
%
% [depth,dir,pos] = mpr_penetration(V1,F1,V2,F2)
%
% Inputs:
